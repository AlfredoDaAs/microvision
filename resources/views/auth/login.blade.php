                            ...
                            <div class="card-body">
                                <form id="frmLogin" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="LoginName" type="text" class="form-control{{ $errors->has('LoginName') ? ' is-invalid' : '' }}" name="LoginName" value="{{ old('LoginName') }}" required autofocus>
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-md-6 offset-md-4">
                                            ...
                                            <button type="button" class="btn btn-secondary float-right" onclick="document.getElementById('frmLogin').reset();">
                                                Clear
                                            </button>
                                        </div>
                                    </div>
